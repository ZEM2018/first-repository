...
<div style=""  class="container-fluid">
    <div class="panel panel-info">
        <div class="panel-heading">比赛明细-修改</div>
        <!--提示信息 -->
        ...
        <form class="form-inline" name="form_modify"  id="form_modify" action="../modify.do" method="post">
             ...
             <input id="mxid" name="mxid" type="text" class="form-control"   placeholder="明细编码" value="${bsmx.mxid}"> 
         </div> 
         <div id="div_bsid" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">比赛编码</div> 
             <input id="bsid" name="bsid" type="text" class="form-control"   placeholder="比赛编码" value="${bsmx.bsid}"> 
         </div> 
         <div id="div_bmid" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">报名编码</div> 
             <input id="bmid" name="bmid" type="text" class="form-control"   placeholder="报名编码" value="${bsmx.bmid}"> 
         </div> 
         <div id="div_bsqh" class="input-group col-xs-5" style="display:none;">
             <div class="input-group-addon">比赛期号</div> 
             <input id="bsqh" name="bsqh" type="text" class="form-control"   placeholder="比赛期号" value="${bsmx.bsqh}"> 
         </div> 
         <div id="div_jsmc" class="input-group col-xs-5" style="display:;"> 
             <div class="input-group-addon">游戏角色名</div> 
             <input id="jsmc" name="jsmc" type="text" class="form-control"   placeholder="游戏角色名" value="${bsmx.jsmc}"> 
         </div> 
         <div id="div_bssj" class="input-group col-xs-5" style="display:none;">
             <div class="input-group-addon">比赛时间</div> 
             <input id="bssj" name="bssj" type="text" class="form-control"   placeholder="比赛时间" value="${bsmx.bssj}"> 
         </div> 
         <div id="div_bscc" class="input-group col-xs-5" style="display:;"> 
             <div class="input-group-addon">吃鸡次数</div> 
             <input id="bscc" name="bscc" type="text" class="form-control"   placeholder="吃鸡次数" value="${bsmx.bscc}"> 
         </div> 
         <div id="div_bsmc" class="input-group col-xs-5" style="display:;"> 
             <div class="input-group-addon">比赛名次</div> 
             <input id="bsmc" name="bsmc" type="text" class="form-control"   placeholder="比赛名次" value="${bsmx.bsmc}"> 
         </div> 
         <div id="div_bszm" class="input-group col-xs-5" style="display:none;">
             <div class="input-group-addon">比赛证明</div> 
             <input id="bszm" name="bszm" type="text" class="form-control"   placeholder="比赛证明" value="${bsmx.bszm}"> 
         </div> 
         <div id="div_bz00" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项00</div> 
             <input id="bz00" name="bz00" type="text" class="form-control"   placeholder="备注项00" value="${bsmx.bz00}"> 
         </div> 
         <div id="div_bz01" class="input-group col-xs-5" style="display:;"> 
             <div class="input-group-addon">比赛奖金</div> 
             <input id="bz01" name="bz01" type="text" class="form-control"   placeholder="比赛奖金" value="${bsmx.bz01}"> 
         </div> 
         <div id="div_bz02" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项02</div> 
             <input id="bz02" name="bz02" type="text" class="form-control"   placeholder="备注项02" value="${bsmx.bz02}"> 
         </div> 
         <div id="div_bz03" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项03</div> 
             <input id="bz03" name="bz03" type="text" class="form-control"   placeholder="备注项03" value="${bsmx.bz03}"> 
         </div> 
         <div id="div_bz04" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项04</div> 
             <input id="bz04" name="bz04" type="text" class="form-control"   placeholder="备注项04" value="${bsmx.bz04}"> 
         </div> 
         <div id="div_bz05" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项05</div> 
             <input id="bz05" name="bz05" type="text" class="form-control"   placeholder="备注项05" value="${bsmx.bz05}"> 
         </div> 
         <div id="div_bz06" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项06</div> 
             <input id="bz06" name="bz06" type="text" class="form-control"   placeholder="备注项06" value="${bsmx.bz06}"> 
         </div> 
         <div id="div_bz07" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项07</div> 
             <input id="bz07" name="bz07" type="text" class="form-control"   placeholder="备注项07" value="${bsmx.bz07}"> 
         </div> 
         <div id="div_bz08" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项08</div> 
             <input id="bz08" name="bz08" type="text" class="form-control"   placeholder="备注项08" value="${bsmx.bz08}"> 
         </div> 
         <div id="div_bz09" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项09</div> 
             <input id="bz09" name="bz09" type="text" class="form-control"   placeholder="备注项09" value="${bsmx.bz09}"> 
         </div> 
         <div id="div_bz10" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项10</div> 
             <input id="bz10" name="bz10" type="text" class="form-control"   placeholder="备注项10" value="${bsmx.bz10}"> 
         </div> 
         <div id="div_bz11" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项11</div> 
             <input id="bz11" name="bz11" type="text" class="form-control"   placeholder="备注项11" value="${bsmx.bz11}"> 
         </div> 
         <div id="div_bz12" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项12</div> 
             <input id="bz12" name="bz12" type="text" class="form-control"   placeholder="备注项12" value="${bsmx.bz12}"> 
         </div> 
         <div id="div_bz13" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项13</div> 
             <input id="bz13" name="bz13" type="text" class="form-control"   placeholder="备注项13" value="${bsmx.bz13}"> 
         </div> 
         <div id="div_bz14" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项14</div> 
             <input id="bz14" name="bz14" type="text" class="form-control"   placeholder="备注项14" value="${bsmx.bz14}"> 
         </div> 
         <div id="div_bz15" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项15</div> 
             <input id="bz15" name="bz15" type="text" class="form-control"   placeholder="备注项15" value="${bsmx.bz15}"> 
         </div> 
         <div id="div_bz16" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项16</div> 
             <input id="bz16" name="bz16" type="text" class="form-control"   placeholder="备注项16" value="${bsmx.bz16}"> 
         </div> 
         <div id="div_bz17" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项17</div> 
             <input id="bz17" name="bz17" type="text" class="form-control"   placeholder="备注项17" value="${bsmx.bz17}"> 
         </div> 
         <div id="div_bz18" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项18</div> 
             <input id="bz18" name="bz18" type="text" class="form-control"   placeholder="备注项18" value="${bsmx.bz18}"> 
         </div> 
         <div id="div_bz19" class="input-group col-xs-5" style="display:none;"> 
             <div class="input-group-addon">备注项19</div> 
             <input id="bz19" name="bz19" type="text" class="form-control"   placeholder="备注项19" value="${bsmx.bz19}"> 
         </div> 
