            ...
            var editor1 = K.create('textarea[name="zwnr"]', {
                ...
                afterCreate: function () {
                    ...
                    K.ctrl(document, 13, function () {
                        self.sync();
                        document.forms['form_modify'].submit();
                    });
...
<div style="" class="container-fluid">
    <div class="panel panel-info">
        <div class="panel-heading">文章信息-修改</div>
        <!--提示信息 -->
        ...
        <div class="row">
            <div class="col-xs-12" style="text-align:center;">
                <button onclick="btn_mod_click();" class="btn btn-info btn-sm glyphicon glyphicon-plus" type="button">
                    修改
                </button>
...
<script type="text/javascript">
    ...
    var _wzid = dvd_get_val("wzid");
    //alert(_wzid);
    var urlZp = "../../../cms/cmsfjZpUpload/list?fuid=" + _wzid + "&t=" + get_guid32();
    //window.open(urlZp);
    document.getElementById("iframeZp").src = urlZp;
